...
import { Home, Radio, Sparkles, FolderTree, Settings, Logs, UserRound, Boxes } from 'lucide-react';

// Page 表示应用支持的固定页面集合。
export type Page = 'home' | 'channel' | 'group' | 'model' | 'account' | 'pool' | 'log' | 'setting';
